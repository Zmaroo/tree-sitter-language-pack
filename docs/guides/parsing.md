...
**Language names** are case-insensitive. Common names include: `python`, `javascript`, `typescript`, `rust`, `java`, `go`, `ruby`, `php`, `c`, `cpp`, `csharp`, `kotlin`, `swift`, `elixir`, `bash`, `sql`, and [170+ others](../languages.md).
