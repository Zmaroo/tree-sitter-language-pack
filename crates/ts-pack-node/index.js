...
function requireNative() {
	if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
		...
		if (process.arch === "arm64") {
			try {
				return require("./ts-pack-node.android-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
				...
				if (
					bindingPackageVersion !== "1.0.0-rc.10" &&
					process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
					process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
				) {
					throw new Error(
						`Native binding package version mismatch, expected 1.0.0-rc.10 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
					);
				}
				return binding;
			} catch (e) {
			...
			try {
				return require("./ts-pack-node.android-arm-eabi.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		if (process.arch === "x64") {
			if (
				...
				try {
					return require("./ts-pack-node.win32-x64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./ts-pack-node.win32-x64-msvc.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			try {
				return require("./ts-pack-node.win32-ia32-msvc.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./ts-pack-node.win32-arm64-msvc.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		try {
			return require("./ts-pack-node.darwin-universal.node");
		} catch (e) {
			loadErrors.push(e);
		}
		try {
		...
		if (process.arch === "x64") {
			try {
				return require("./ts-pack-node.freebsd-x64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./ts-pack-node.freebsd-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		if (process.arch === "x64") {
			if (isMusl()) {
				try {
					return require("./ts-pack-node.linux-x64-musl.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./ts-pack-node.linux-x64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			if (isMusl()) {
				try {
					return require("./ts-pack-node.linux-arm64-musl.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./ts-pack-node.linux-arm64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			if (isMusl()) {
				try {
					return require("./ts-pack-node.linux-arm-musleabihf.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./ts-pack-node.linux-arm-gnueabihf.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			if (isMusl()) {
				try {
					return require("./ts-pack-node.linux-loong64-musl.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./ts-pack-node.linux-loong64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			if (isMusl()) {
				try {
					return require("./ts-pack-node.linux-riscv64-musl.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./ts-pack-node.linux-riscv64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			try {
				return require("./ts-pack-node.linux-ppc64-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./ts-pack-node.linux-s390x-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		if (process.arch === "arm64") {
			try {
				return require("./ts-pack-node.openharmony-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./ts-pack-node.openharmony-x64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./ts-pack-node.openharmony-arm.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
	...
	try {
		wasiBinding = require("./ts-pack-node.wasi.cjs");
