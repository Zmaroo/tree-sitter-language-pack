...
/// Extract all metadata from a parsed source file.
pub fn extract_metadata(source: &str, language: &str, tree: &Tree) -> FileMetadata {
...
mod tests {
    ...
    fn test_extract_python_function() {
        ...
        let intel = extract_metadata(source, "python", &tree);
    ...
    fn test_extract_rust_function() {
        ...
        let intel = extract_metadata(source, "rust", &tree);
