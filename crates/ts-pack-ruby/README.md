...
# tree-sitter-language-pack — Ruby
...
For detailed API documentation, see the [Ruby package](https://github.com/kreuzberg-dev/tree-sitter-language-pack/tree/main/crates/ts-pack-ruby).
