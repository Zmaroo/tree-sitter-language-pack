...
For detailed API documentation, see the [C# package](https://github.com/kreuzberg-dev/tree-sitter-language-pack/tree/main/packages/csharp/TreeSitterLanguagePack).
